        ...
        <div className="bg-white p-10 sm:p-14 rounded-[3rem] shadow-2xl shadow-gray-200/50 border border-gray-100 flex flex-col h-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <button
                    ...
                    className={`w-full bg-black text-white px-6 py-3 rounded-xl font-semibold transition transform hover:scale-[1.02] ${isSubmitting ? 'opacity-50 cursor-not-allowed' : 'hover:bg-orange-500'
                        }`}
                >
