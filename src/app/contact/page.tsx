            ...
            <section className="py-12 min-h-[60vh]">
                <div className="max-w-screen-xl mx-auto px-6 sm:px-12 md:px-20 lg:px-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="bg-white p-10 sm:p-14 rounded-[3rem] shadow-2xl shadow-gray-200/50 border border-gray-100 flex flex-col h-full">
                        <div className="mb-12">
                            <h3 className="text-4xl font-black uppercase tracking-tight text-[#0A2540] mb-4">Get in <span className="text-cyan-500">Touch</span></h3>
                        ...
                        {mainOffice ? (
                                ...
                                <div className="space-y-8">
                                    <div className="flex gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#0A2540] font-bold text-lg leading-tight">{mainOffice.address}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#0A2540] font-bold text-lg leading-tight">{mainOffice.phone}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#0A2540] font-bold text-lg">{mainOffice.office_hours}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    <p className="text-[#0A2540] font-bold text-xl leading-tight">USA Head Office</p>
                                    <p className="text-gray-600 font-medium">5410 BROOKWAY WILLOW DR, SPRING TX 77379-2840, USA</p>
                                    <p className="text-cyan-500 font-black">+1 (302) 367-9366</p>
                                </div>
                            </div>
                        )}
