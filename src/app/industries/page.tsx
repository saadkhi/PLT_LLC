        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="pt-24 pb-12 px-6 sm:px-12 md:px-20 lg:px-32 text-center">
                <h1 className="text-fluid-h1 font-black uppercase tracking-tighter text-[#0A2540]">
                    Industries <span className="text-cyan-500">We Serve</span>
                </h1>
                ...
                <div className="max-w-screen-xl mx-auto px-6 sm:px-12 md:px-20 lg:px-32">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {industries.map((industry: any) => (
                            <div key={industry.id} className="group bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 p-8 flex flex-col items-center text-center border border-gray-100 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-cyan-500/5">
                                <div className="w-24 h-24 mb-6 relative">
                                    <div className="absolute inset-0 bg-cyan-50 rounded-2xl rotate-6 group-hover:rotate-12 transition-transform duration-500" />
                                    <Image
                                ...
                                <h3 className="text-2xl font-black tracking-tight text-[#0A2540] mb-4">{industry.name}</h3>
