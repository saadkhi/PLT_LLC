                    ...
                    {categories.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="w-full lg:w-1/2 group relative">
                                <div className="absolute -inset-4 bg-orange-500/5 rounded-[3rem] blur-2xl group-hover:bg-orange-500/10 transition-colors duration-500" />
                                <Image
                            ...
                            <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
                                <div className="inline-flex items-center space-x-2 bg-orange-50 px-4 py-2 rounded-full border border-orange-100">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-widest text-orange-600">Featured Service</span>
                                </div>
                                <h3 className="text-4xl sm:text-5xl font-black tracking-tight text-black">{service.name}</h3>
                                ...
                                <div className="pt-4 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                                    ...
                                    <Link
                                        href="/contact"
                                        className="w-full sm:w-auto px-8 py-4 bg-white text-black font-bold rounded-2xl border border-gray-200 hover:border-black transition-colors"
                                    >
                                        Inquire Now
                                    </Link>
                                </div>
            ...
            <section className="py-32 bg-white relative overflow-hidden">
                <div className="max-w-screen-xl mx-auto px-6 sm:px-12 md:px-20 lg:px-32 relative">
                    <div className="max-w-3xl mb-20 text-center mx-auto lg:text-left lg:mx-0">
                        <h2 className="text-fluid-h2 font-black uppercase tracking-tighter text-black mb-6">Why Choose <span className="text-orange-500">Us</span></h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="group p-10 rounded-[2rem] bg-gray-50/50 border border-transparent hover:border-orange-100 hover:bg-white hover:shadow-2xl hover:shadow-orange-500/5 transition-all duration-500">
                                <div className="w-12 h-12 bg-white rounded-2xl shadow-lg flex items-center justify-center mb-6 group-hover:bg-orange-500 group-hover:text-white transition-colors duration-500">
                                    <CheckCircle2 size={24} />
                                </div>
                                <h3 className="text-2xl font-black tracking-tight text-black mb-4">{feature.title}</h3>
