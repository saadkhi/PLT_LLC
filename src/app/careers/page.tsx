        ...
        <div className="bg-white min-h-screen">
            ...
            <section className="py-12 min-h-[50vh]">
                <div className="max-w-4xl mx-auto px-6 sm:px-12 md:px-20 lg:px-32 space-y-6">
                    {jobs.map((job) => (
                        <div key={job.id} className="group bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 p-8 flex flex-col sm:flex-row justify-between items-center border border-gray-100 transition-all duration-300 hover:shadow-2xl hover:border-cyan-100">
                            <div className="text-center sm:text-left mb-6 sm:mb-0">
                                <h3 className="text-2xl font-black tracking-tight text-[#0A2540] mb-2 group-hover:text-cyan-500 transition-colors uppercase">{job.title}</h3>
                            ...
                            <Link
                                href={`/careers/${job.id}`}
                                className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-navy-900 text-white font-black uppercase tracking-widest text-xs rounded-2xl hover:bg-cyan-500 transition-all duration-300 shadow-lg shadow-gray-200"
                            >
