        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-[clamp(2.5rem,6vw,4.5rem)] font-black uppercase tracking-tighter leading-none mb-6"> Our <span className="text-orange-500">Services</span></h2>
            ...
            <Link href="/services" className="group flex items-center gap-2 text-sm font-black uppercase tracking-widest text-orange-500 hover:text-black transition-colors">
              View All Services
      ...
      <section className="py-24 px-6 sm:px-12 md:px-20 lg:px-32 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-[clamp(2.5rem,6vw,4.5rem)] font-black uppercase tracking-tighter leading-none mb-6">What People <span className="text-orange-500">Say</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm transition-all duration-500 hover:shadow-xl hover:shadow-orange-500/5">
                <div className="flex gap-1 mb-8">
                  {[...Array(5)].map((_, idx) => (
                    <svg key={idx} className="w-5 h-5 text-orange-500 fill-current" viewBox="0 0 20 20">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-orange-100 rounded-2xl flex items-center justify-center font-black text-orange-500 text-xl shadow-inner uppercase">
                    {t.name.charAt(0)}
                  </div>
                  <div>
                    <h4 className="font-black uppercase tracking-tight text-black">{t.name}</h4>
                    <p className="text-xs uppercase font-bold tracking-widest text-orange-500">{t.role}</p>
                  </div>
                </div>
              </div>
            ))}
