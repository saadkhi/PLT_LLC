                ...
                <div className="max-w-screen-xl mx-auto px-6 sm:px-12 md:px-20 lg:px-32 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                    ...
                    <div className="lg:col-span-5 bg-white rounded-[2.5rem] shadow-2xl shadow-gray-100/50 p-8 sm:p-12 flex flex-col items-center text-center border border-gray-100 transition-transform duration-500 hover:scale-[1.01]">
                        <div className="relative w-48 h-48 sm:w-56 sm:h-56 mb-8 group">
                            <div className="absolute inset-0 bg-cyan-500 rounded-[2rem] rotate-6 group-hover:rotate-12 transition-transform duration-500 opacity-20"></div>
                            <Image
                        ...
                        <h3 className="text-3xl font-black uppercase tracking-tight text-[#0A2540] mb-1">Saad Ather Ali</h3>
                        <p className="text-xs uppercase font-bold tracking-widest text-cyan-500 mb-6">Chief Executive Officer</p>
                        ...
                        <div className="flex gap-4 w-full">
                            ...
                            <a href="https://github.com/saadkhi" target="_blank" rel="noopener noreferrer"
                                className="flex-1 flex items-center justify-center gap-2 bg-navy-900 text-white px-6 py-4 rounded-2xl shadow-lg shadow-gray-900/20 hover:bg-gray-800 transition-all duration-300 font-bold text-sm">
                                <LinkIcon size={18} />
                                <span>GitHub</span>
                            </a>
                        </div>
                    ...
                    <div className="lg:col-span-7 space-y-8">
                        <div className="bg-white shadow-xl shadow-gray-200/40 rounded-[2.5rem] p-8 sm:p-12 border border-gray-100 h-full">
                            <div className="w-12 h-1.5 bg-cyan-500 rounded-full mb-8" />
                            <div className="space-y-6 text-gray-700 leading-relaxed sm:text-lg">
                                <p>
                                    At <span className="font-bold text-[#0A2540] border-b-2 border-cyan-200">Primeline IT Services</span>, we are more than just a software agency — we are a partner in digital transformation. Founded with a mission to deliver impactful solutions, our team of experts specializes in creating scalable, innovative, and future-ready technologies that empower businesses to thrive in competitive markets.
                                </p>
                                <p>
                                ...
                                <p className="font-medium italic text-[#0A2540]/80">
